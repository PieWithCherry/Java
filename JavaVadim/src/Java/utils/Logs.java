...
public class Logs {
     ...
     *                    пример (абсолютный путь): C:\\Users\\Вадимка\\IdeaProjects\\JavaVadim\\main.log.2014-11-17
     ...
     *                    пример(абсолютный путь): C:\\Users\\Вадимка\\IdeaProjects\\JavaVadim\\main.log.2014-11-17_logs\\
     */
     ...
     *                    пример (файл в директории программы): main.log.2014-11-17
     *                    пример (абсолютный путь): C:\Users\Вадимка\IdeaProjects\JavaVadim
     * @param nameNewFile - основная часть названия новых файлов с папкой (и название папки)
     *                    пример: main.log.2014-11-17_logs
     */
